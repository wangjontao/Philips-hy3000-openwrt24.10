...
define Device/philips_hy3000
  ...
  DEVICE_PACKAGES := kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware f2fsck losetup mkf2fs kmod-fs-f2fs kmod-mmc luci-app-samba4 kmod-eeprom-at24 e2fsprogs fdisk partx-utils
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
    ARTIFACT/nor-factory.bin		:= append-openwrt-one-eeprom
endef
